...
TCMR_DB_DIR = '/opt/data/private/projects/MPS-Net-hafi/data/preprocessed_data'
...
# STAF model hyperparams
cfg.MODEL.PyMAF = CN()
cfg.MODEL.PyMAF.MAF_ON = True
cfg.MODEL.PyMAF.BACKBONE = 'res50'
cfg.MODEL.PyMAF.MLP_DIM = [256, 128, 64, 5]
cfg.MODEL.PyMAF.N_ITER = 3
cfg.MODEL.PyMAF.AUX_SUPV_ON = True

# Res50 model hyperparams
cfg.RES_MODEL = CN()
cfg.RES_MODEL.DECONV_WITH_BIAS = False
cfg.RES_MODEL.NUM_DECONV_LAYERS = 3
cfg.RES_MODEL.NUM_DECONV_FILTERS = [256, 256, 256]
cfg.RES_MODEL.NUM_DECONV_KERNELS = [4, 4, 4]
