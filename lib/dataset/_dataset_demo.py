...
class FeatureDataset(Dataset):
    def __init__(self, image_folder, frames, seq_len=16):
        ...
        self.seq_list = [[i, i + seq_len - 1] for i in
                         range(len(self.image_file_names) - seq_len + 1)]  # [i, i+seq_len-1] is inclusive
    ...
    def get_sequence(self, start_index, end_index):
        ...
        if start_index != end_index:
            ...
            return self.feature_list[start_index][None, :].expand(self.seq_len, 2048, 7, 7)
